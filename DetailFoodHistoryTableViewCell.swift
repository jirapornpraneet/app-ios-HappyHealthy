...
class DetailFoodHistoryTableViewCell: UITableViewCell {
    ...
    var  DetailFoodHistoryTableViewCell:ListFoodHistory?{
        didSet{
//            let amountFood = String(format: "%i", (DetailFoodHistoryTableViewCell?.Food_TotalAmount)!)
...
//            totalAmount = (amountTotalFood! * kcalSum!)
            
            nameFoodLabel.text = DetailFoodHistoryTableViewCell?.Food_Name
            kcalFoodLabel.text = String(format: "%.02f", (DetailFoodHistoryTableViewCell?.Food_Calories)!)
            amountFoodLabel.text = String(format: "%.02f", (DetailFoodHistoryTableViewCell?.Food_TotalAmount)!)
